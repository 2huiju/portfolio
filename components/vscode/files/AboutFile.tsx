...
export function AboutFile() {
  return (
    <MdDoc>
      <H1># About</H1>
      <Pp>
        안녕하세요, <Strong>사용자의 문제를 정의하고 끝까지 해결하는 과정에서 재미를 느끼는</Strong> 4년차 프론트엔드
        개발자 이희주입니다. 기획자·디자이너·개발자와 적극적으로 소통하며 문제를 정의하고, 효과적인 해결책을
        도출하는 것을 좋아합니다. 최근에는 AI 도구를 개발 워크플로우에 적극 도입해 협업 효율과 생산성을 높이고
        있습니다.
      </Pp>
